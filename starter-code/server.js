...
app.post('/articles', function(request, response) {
  client.query(
    ...
    `,
    // TODONE: Add the author and "authorUrl" as data for the SQL query
  ...
  function queryTwo() {
    client.query(
      ...
      WHERE author = $1
      `,
      // TODONE: Add the author name as data for the SQL query
      [request.body.author],
      function(err, result) {
        if (err) console.error(err)
  ...
  function queryThree(author_id) {
    client.query(
      ...
      VALUES($1, $2, $3, $4, $5)
      `,
      // TODONE: Add the data from our new article, including the author_id, as data for the SQL query.
...
app.put('/articles/:id', function(request, response) {
  ...
  .then(function() {
    ...
    // TODONE: Write a SQL query to update an article record. Keep in mind that article records now have an author_id, in addition to title, category, publishedOn, and body.
      ...
      `,
    // TODONE: Add the required values from the request as data for the SQL query to interpolate
      [request.body_author_id, request.body_title, request.body.category, request.body.publishedOn, request.body.body, request.params.id]
    )
  })
  .then(function() {
